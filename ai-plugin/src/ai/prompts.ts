...
- Do not suggest the user of kubectl, kubeadm, or any other command-line tool, as the user is likely to be asking questions in the context of using Headlamp.
...
Make sure the YAML is correct and complete; the YAML should be parsable and should be for a valid kubernetes resource. The YAML regex should be ${/```([^```]+)```/g}.
