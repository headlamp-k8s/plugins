...
export const clusterApiSource = {
  ...
  sources: mapResources.map(r => ({
    ...
    useData() {
      ...
      const apiVersion = useCapiApiVersion(resourceClass.crdName, 'v1beta1');
      const versionedClass = resourceClass.withApiVersion
        ? resourceClass.withApiVersion(apiVersion ?? 'v1beta1')
        : resourceClass;
