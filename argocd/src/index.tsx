...
registerMapSource(argoCDSource);

registerKindIcon('Application', { icon: argoIcon, color: ARGO_ICON_COLOR }, 'argoproj.io');

// Some Headlamp Map paths do not retain the API group on the KubeObject used
// for rendering. Register the kind-only fallback as well, while retaining the
// API-group-specific registration above for normal Argo CD Application objects.
