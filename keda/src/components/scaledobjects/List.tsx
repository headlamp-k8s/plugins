  ...
  return isKedaInstalled ? (
    <ResourceListView
      ...
      columns={[
        ...
        'namespace',
        {
          id: 'scale-target-kind',
          label: 'ScaleTargetKind',
          getValue: item => `${item.scaleTargetApiVersion}.${item.scaleTargetKind}`,
        },
        {
          id: 'scale-target-name',
          label: 'ScaleTargetName',
          getValue: null,
          render: item => (
            <Link
