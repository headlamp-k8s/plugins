...
| [cluster-api](./cluster-api) | See your Cluster API management clusters in Headlamp's sidebar and map. | Learn more about CAPI with the [Cluster API book](https://cluster-api.sigs.k8s.io/). | [@mboersma](https://github.com/mboersma) [@ChayanDass](https://github.com/ChayanDass) |
...
| [Beacon](https://github.com/KerberOps/headlamp-beacon) | Monitor versions of Headlamp plugins, core infrastructure deployments, and business apps. Visual status badges show up-to-date, outdated, or error state at a glance. | [ArtifactHub](https://artifacthub.io/packages/headlamp/headlamp-beacon/headlamp-beacon) | [@KerberOps](https://github.com/KerberOps) |
