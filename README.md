...
| [cnpg](./cnpg) | A read-only view of CloudNativePG clusters, their topology, and their backup and restore confidence. | Alpha. Requires the [CloudNativePG operator](https://cloudnative-pg.io/); stays hidden on clusters without it. | [@gambtho](https://github.com/gambtho) |
