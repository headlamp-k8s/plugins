  ...
  return (
    <Box sx={{ p: 2, maxWidth: 560 }}>
      <Alert severity="info" sx={{ mb: 2 }}>
        <strong>ResourceEditor</strong> opens from the topology view when editing a Strimzi
        resource. It uses <code>ApiProxy</code> and <code>@monaco-editor/react</code>.
      </Alert>
      <Typography variant="body2" color="text.secondary">
        Run the plugin in Headlamp, open a Kafka cluster topology, and use edit actions to see this
        component.
      </Typography>
    </Box>
  );
