...
abstract class CleanupPolicyBase extends KubeObject<CleanupPolicyInterface> {
  get spec() {
...
export class CleanupPolicy extends CleanupPolicyBase {
...
export class ClusterCleanupPolicy extends CleanupPolicyBase {
