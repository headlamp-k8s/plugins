...
abstract class PolicyReportBase extends KubeObject<PolicyReportInterface> {
...
export class PolicyReport extends PolicyReportBase {
...
export class ClusterPolicyReport extends PolicyReportBase {
