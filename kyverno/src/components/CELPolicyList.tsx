    ...
    <Box>
      ...
      <SimpleTable
        columns={[
          ...
          {
            label: 'Actions',
            getter: (row: ValidatingPolicyRow) => row.validationActions.join(', '),
          },
          { label: 'Validations', getter: (row: ValidatingPolicyRow) => row.validationCount },
          {
            label: 'Age',
            getter: (row: ValidatingPolicyRow) =>
    ...
    <Box>
      ...
      <SimpleTable
        columns={[
          ...
          {
            label: 'Age',
            getter: (row: GeneratingPolicyRow) =>
              row.creationTimestamp ? (
                <DateLabel date={row.creationTimestamp} format="mini" />
              ) : (
                '—'
