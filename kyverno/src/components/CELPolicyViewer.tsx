            ...
            <Table size="small">
              ...
              <TableBody>
                {constraints.resourceRules.map((rule: any, i: number) => (
                  <TableRow key={i}>
                    <TableCell>
                      <Box sx={{ fontFamily: 'monospace' }}>{rule.apiGroups?.join(', ') || '*'}</Box>
                    </TableCell>
                    <TableCell>
                      <Box sx={{ fontFamily: 'monospace' }}>{rule.apiVersions?.join(', ') || '*'}</Box>
                    </TableCell>
                    <TableCell>
                      <Box sx={{ fontFamily: 'monospace' }}>{rule.operations?.join(', ') || '*'}</Box>
                    </TableCell>
                    <TableCell>
                      <Box sx={{ fontFamily: 'monospace' }}>{rule.resources?.join(', ') || '*'}</Box>
                    </TableCell>
                  </TableRow>
                ))}
              </TableBody>
