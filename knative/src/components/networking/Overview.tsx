...
import { formatIngressClass, getIngressClass, getIngressClassRaw, INGRESS_CLASS_GATEWAY_API } from '../../config/ingress';
...
function useIngressClassForCluster(cluster: string): IngressClassHookResult {
  ...
  const raw = getIngressClassRaw(networkConfig?.data);
