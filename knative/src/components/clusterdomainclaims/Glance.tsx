...
/**
 * Renders a brief "glance" summary for a ClusterDomainClaim on the map.
 * Displays the owner namespace.
 *
 * @param props - Component properties.
 * @param props.node - The map node containing the resource.
 */
export function ClusterDomainClaimGlance({ node }: GlanceProps) {
  if (node.kubeObject?.kind === ClusterDomainClaim.kind) {
    const cdc = node.kubeObject as ClusterDomainClaim;
