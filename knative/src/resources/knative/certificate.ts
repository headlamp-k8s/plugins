...
import { getFirstOwner } from './resourceData';

interface KnativeCertificateResource extends KubeObjectInterface {
  spec?: {
    dnsNames?: string[];
    domain?: string;
    secretName?: string;
...
export class KnativeCertificate extends ConditionedKnativeCustomResource<KnativeCertificateResource> {
