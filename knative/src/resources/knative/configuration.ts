...
import type { Container } from './revision';

interface KnativeConfigurationResource extends KubeObjectInterface {
  spec?: {
    template?: {
      metadata?: {
...
export class KnativeConfiguration extends ConditionedKnativeCustomResource<KnativeConfigurationResource> {
