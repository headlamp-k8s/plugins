...
/**
 * Prefer capi_* metrics with controller_runtime_* fallback (CAPI Grafana dashboard pattern).
 */
...
/** Webhook path suffix used by CAPI admission webhooks (e.g. v1beta2-machinedeployment). */
