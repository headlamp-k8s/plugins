...
export function AppCatalogSettings() {
  ...
  function handleSave(value) {
    const updatedConfig = { showVerified: value };
  ...
  function toggleShowVerified() {
    const newShowVerified = currentConfig?.showVerified;
    handleSave(!newShowVerified);
  }
        ...
        rows={[
          {
            ...
            value: (
              <EnableSwitch checked={!!currentConfig?.showVerified} onChange={toggleShowVerified} />
            ),
          },
        ]}
      />
