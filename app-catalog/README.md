...
This plugin enables the ability to browse for Helm charts directly within the Headlamp UI, using categories and filters that are consistent with those on ArtifactHub.
The App Catalog provides detailed chart information and metadata directly within Headlamp, allowing users to make informed decisions about the resources they want to deploy. 
This centralized access reduces the need for external tools and improves the management process.  
