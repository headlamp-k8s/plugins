  ...
  return (
    <Box>
      ...
      {certificateRequest.status?.conditions &&
        certificateRequest.status.conditions.length > 0 && (
...
const approvedAndReadyRequest: MockCertificateRequestDetail = {
  ...
  status: {
    ...
    certificate:
      'LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tCk1JSURJVENDQWdtZ0F3SUJBZ0lSQU9GQktrNjJya...',
...
const pendingRequest: MockCertificateRequestDetail = {
  ...
  spec: {
    ...
    request:
      'LS0tLS1CRUdJTiBDRVJUSUZJQ0FURSBSRVFVRVNULS0tLS0KTUlJQ3dqQ0NBYWtDQVFBd0FEQ...',
...
const deniedRequest: MockCertificateRequestDetail = {
  ...
  spec: {
    ...
    request:
      'LS0tLS1CRUdJTiBDRVJUSUZJQ0FURSBSRVFVRVNULS0tLS0KTUlJQ3dqQ0NBYWtDQVFBd0FE...',
