...
const pendingHTTP01Challenge: MockChallengeDetail = {
  ...
  spec: {
    dnsName: 'example.com',
    authorizationURL:
      'https://acme-v02.api.letsencrypt.org/acme/authz-v3/123456789',
    type: 'HTTP-01',
    issuerRef: {
...
const validHTTP01Challenge: MockChallengeDetail = {
  ...
  spec: {
    ...
    authorizationURL:
      'https://acme-v02.api.letsencrypt.org/acme/authz-v3/987654321',
    type: 'HTTP-01',
    issuerRef: {
      name: 'letsencrypt-prod',
      kind: 'ClusterIssuer',
...
const pendingDNS01Challenge: MockChallengeDetail = {
  ...
  spec: {
    dnsName: '*.example.com',
    authorizationURL:
      'https://acme-v02.api.letsencrypt.org/acme/authz-v3/111222333',
    type: 'DNS-01',
    issuerRef: {
...
const invalidChallenge: MockChallengeDetail = {
  ...
  spec: {
    ...
    authorizationURL:
      'https://acme-staging-v02.api.letsencrypt.org/acme/authz-v3/444555666',
    type: 'HTTP-01',
    issuerRef: {
...
const erroredChallenge: MockChallengeDetail = {
  ...
  spec: {
    ...
    authorizationURL:
      'https://acme-v02.api.letsencrypt.org/acme/authz-v3/777888999',
    type: 'HTTP-01',
    issuerRef: {
      name: 'letsencrypt-prod',
      kind: 'ClusterIssuer',
  ...
  status: {
    ...
    processing: false,
    reason:
      'Error accepting authorization: rateLimited: too many failed authorizations recently',
  },
};
...
const dns01Route53Challenge: MockChallengeDetail = {
  ...
  spec: {
    ...
    authorizationURL:
      'https://acme-v02.api.letsencrypt.org/acme/authz-v3/999000111',
    type: 'DNS-01',
    issuerRef: {
      name: 'letsencrypt-prod',
      kind: 'ClusterIssuer',
