...
export function KomposeUI() {
  ...
  // the value is set.
  const [composeYAMLToConvert, setComposeYAMLToConvert] = React.useState<{yaml: string}>({yaml: ''});
    ...
    <SectionBox title="Kompose (beta)" paddingTop={2}>
      <Box>
        ...
        <Typography variant="body1">
          ...
          <em>headlamp-tools</em> namespace. It will be created if it doesn't exist (so make sure your role allows this).
        </Typography>
