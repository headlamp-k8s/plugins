...
const LazyGraphView = React.lazy(() => import('../components/resourceMap/GraphView').then(it => ({ default: it.GraphView })));
const defaultRoutes = {
    cluster: {
        path: '/',
        exact: true,
    ...
    namespaces: {
        ...
        exact: true,
        sidebar: 'namespaces',
        component: () => _jsx(NamespacesList, {}),
    },
    namespace: {
        path: '/namespaces/:name',
        sidebar: 'namespaces',
        component: () => _jsx(NamespaceDetails, {}),
    },
    nodes: {
        path: '/nodes',
        name: 'Nodes',
        exact: true,
        sidebar: 'nodes',
        component: () => _jsx(NodeList, {}),
    },
    node: {
        path: '/nodes/:name',
        sidebar: 'nodes',
        component: () => _jsx(NodeDetails, {}),
    },
    storageClasses: {
        ...
        component: () => _jsx(StorageClassList, {}),
    },
    storageClass: {
        path: '/storage/classes/:name',
        name: 'Storage Classes',
        sidebar: 'storageClasses',
        component: () => _jsx(StorageClassDetails, {}),
    },
    persistentVolumes: {
        ...
        component: () => _jsx(PersistentVolumeList, {}),
    },
    persistentVolume: {
        ...
        component: () => _jsx(PersistentVolumeDetails, {}),
    },
    persistentVolumeClaims: {
        ...
        component: () => _jsx(PersistentVolumeClaimList, {}),
    },
    persistentVolumeClaim: {
        path: '/storage/persistentvolumeclaims/:namespace/:name',
        sidebar: 'persistentVolumeClaims',
        exact: true,
        component: () => _jsx(PersistentVolumeClaimDetails, {}),
    },
    workloads: {
        path: '/workloads',
        exact: true,
        name: 'Workloads',
        sidebar: 'workloads',
        component: () => _jsx(WorkloadOverview, {}),
    },
    DaemonSet: {
        path: '/daemonsets/:namespace/:name',
        exact: true,
        sidebar: 'DaemonSets',
        component: () => _jsx(DaemonSetDetails, {}),
    },
    StatefulSet: {
        path: '/statefulsets/:namespace/:name',
        exact: true,
        sidebar: 'StatefulSets',
        component: () => _jsx(StatefulSetDetails, {}),
    },
    Deployment: {
        path: '/deployments/:namespace/:name',
        exact: true,
        sidebar: 'Deployments',
        component: () => _jsx(WorkloadDetails, { workloadKind: Deployment }),
    },
    Job: {
        path: '/jobs/:namespace/:name',
        exact: true,
        sidebar: 'Jobs',
        component: () => _jsx(WorkloadDetails, { workloadKind: Job }),
    },
    CronJob: {
        path: '/cronjobs/:namespace/:name',
        exact: true,
        sidebar: 'CronJobs',
        component: () => _jsx(CronJobDetails, {}),
    },
    Pods: {
        path: '/pods',
        exact: true,
        name: 'Pods',
        sidebar: 'Pods',
        component: () => _jsx(PodList, {}),
    },
    Pod: {
        path: '/pods/:namespace/:name',
        exact: true,
        sidebar: 'Pods',
        component: () => _jsx(PodDetails, {}),
    },
    services: {
        path: '/services',
        exact: true,
        name: 'Services',
        sidebar: 'services',
        component: () => _jsx(ServiceList, {}),
    },
    service: {
        path: '/services/:namespace/:name',
        exact: true,
        sidebar: 'services',
        component: () => _jsx(ServiceDetails, {}),
    },
    endpoints: {
        path: '/endpoints',
        exact: true,
        name: 'Endpoints',
        sidebar: 'endpoints',
        component: () => _jsx(EndpointList, {}),
    },
    endpoint: {
        path: '/endpoints/:namespace/:name',
        exact: true,
        sidebar: 'endpoints',
        component: () => _jsx(EndpointDetails, {}),
    },
    ingresses: {
        path: '/ingresses',
        exact: true,
        name: 'Ingresses',
        sidebar: 'ingresses',
        component: () => _jsx(IngressList, {}),
    },
    ingress: {
        path: '/ingresses/:namespace/:name',
        exact: true,
        sidebar: 'ingresses',
        component: () => _jsx(IngressDetails, {}),
    },
    ingressclasses: {
        path: '/ingressclasses',
        exact: true,
        ...
        component: () => _jsx(IngressClassList, {}),
    },
    ingressclass: {
        path: '/ingressclasses/:name',
        exact: true,
        sidebar: 'ingressclasses',
        component: () => _jsx(IngressClassDetails, {}),
    },
    networkPolicies: {
        path: '/networkpolicies',
        exact: true,
        sidebar: 'NetworkPolicies',
        component: () => _jsx(NetworkPolicyList, {}),
    },
    networkPolicy: {
        path: '/networkpolicies/:namespace/:name',
        exact: true,
        sidebar: 'NetworkPolicies',
        component: () => _jsx(NetworkPolicyDetails, {}),
    },
    DaemonSets: {
        path: '/daemonsets',
        exact: true,
    ...
    Deployments: {
        ...
        sidebar: 'Deployments',
        name: 'Deployments',
        component: () => _jsx(DeploymentsList, {}),
    },
    StatefulSets: {
        path: '/statefulsets',
        exact: true,
        sidebar: 'StatefulSets',
        name: 'StatefulSets',
        component: () => _jsx(StatefulSetList, {}),
    },
    ReplicaSets: {
        path: '/replicasets',
        exact: true,
        name: 'ReplicaSets',
        sidebar: 'ReplicaSets',
        component: () => _jsx(ReplicaSetList, {}),
    },
    ReplicaSet: {
        path: '/replicasets/:namespace/:name',
        exact: true,
        sidebar: 'ReplicaSets',
        component: () => _jsx(WorkloadDetails, { workloadKind: ReplicaSet }),
    },
    configMaps: {
        path: '/configmaps',
        exact: true,
        name: 'Config Maps',
        sidebar: 'configMaps',
        component: () => _jsx(ConfigMapList, {}),
    },
    configMap: {
        path: '/configmaps/:namespace/:name',
        exact: true,
        sidebar: 'configMaps',
        component: () => _jsx(ConfigDetails, {}),
    },
    serviceAccounts: {
        ...
        component: () => _jsx(ServiceAccountList, {}),
    },
    serviceAccount: {
        path: '/serviceaccounts/:namespace/:name',
        exact: true,
        sidebar: 'serviceAccounts',
        component: () => _jsx(ServiceAccountDetails, {}),
    },
    roles: {
        path: '/roles',
        exact: true,
        name: 'Roles',
        sidebar: 'roles',
        component: () => _jsx(RoleList, {}),
    },
    role: {
        path: '/roles/:namespace/:name',
        exact: true,
        sidebar: 'roles',
        component: () => _jsx(RoleDetails, {}),
    },
    clusterrole: {
    ...
    roleBindings: {
        ...
        component: () => _jsx(RoleBindingList, {}),
    },
    roleBinding: {
        ...
        name: 'Role Binding',
        sidebar: 'roleBindings',
        component: () => _jsx(RoleBindingDetails, {}),
    },
    clusterRoleBinding: {
    ...
    secrets: {
        ...
        name: 'Secrets',
        sidebar: 'secrets',
        component: () => _jsx(SecretList, {}),
    },
    secret: {
        path: '/secrets/:namespace/:name',
        exact: true,
        sidebar: 'secrets',
        component: () => _jsx(SecretDetails, {}),
    },
    ...
    priorityclasses: {
        ...
        component: () => _jsx(PriorityClassList, {}),
    },
    priorityClass: {
        ...
        name: 'PriorityClass',
        sidebar: 'priorityClasses',
        component: () => _jsx(PriorityClassDetails, {}),
    },
    resourceQuotas: {
        path: '/resourcequotas',
        exact: true,
        ...
        component: () => _jsx(ResourceQuotaList, {}),
    },
    resourceQuota: {
        ...
        name: 'Resource Quota',
        sidebar: 'resourceQuotas',
        component: () => _jsx(ResourceQuotaDetails, {}),
    },
    leases: {
        path: '/leases',
        exact: true,
    ...
    runtimeClasses: {
        ...
        component: () => _jsx(RuntimeClassList, {}),
    },
    runtimeClass: {
        ...
        name: 'Runtime Class',
        sidebar: 'runtimeClasses',
        component: () => _jsx(RuntimeClassDetails, {}),
    },
    limitRanges: {
        path: '/limitranges',
        exact: true,
    ...
    limitRange: {
        ...
        name: 'Limit Range',
        sidebar: 'limitRanges',
        component: () => _jsx(LimitRangeDetails, {}),
    },
    mutatingWebhookConfigurations: {
        ...
        component: () => _jsx(MutatingWebhookConfigList, {}),
    },
    mutatingWebhookConfiguration: {
        ...
        sidebar: 'mutatingWebhookConfigurations',
        component: () => _jsx(MutatingWebhookConfigurationDetails, {}),
    },
    validatingWebhookConfigurations: {
        ...
        component: () => _jsx(ValidatingWebhookConfigurationList, {}),
    },
    validatingWebhookConfiguration: {
        ...
        sidebar: 'validatingWebhookConfigurations',
        component: () => _jsx(ValidatingWebhookConfigurationDetails, {}),
    },
    ...
    login: {
        ...
        sidebar: null,
        noAuthRequired: true,
        component: () => (_jsx(AuthChooser, { children: _jsx(LocaleSelect, {}) })),
    },
    crds: {
        path: '/crds',
        exact: true,
        name: 'CRDs',
        sidebar: 'crds',
        component: () => _jsx(CustomResourceDefinitionList, {}),
    },
    crd: {
        path: '/crds/:name',
        exact: true,
        name: 'CRD',
        sidebar: 'crds',
        component: () => _jsx(CustomResourceDefinitionDetails, {}),
    },
    customresource: {
        ...
        sidebar: 'crds',
        component: () => _jsx(CustomResourceDetails, {}),
    },
    customresources: {
        ...
        sidebar: 'crds',
        component: () => _jsx(CustomResourceList, {}),
    },
    crs: {
        path: '/crs',
        exact: true,
    ...
    notifications: {
        ...
        noAuthRequired: true,
        component: () => (_jsx(PageGrid, { children: _jsx(NotificationList, {}) })),
    },
    settings: {
        ...
        useClusterURL: false,
        noAuthRequired: true,
        component: () => (_jsx(PageGrid, { children: _jsx(Settings, {}) })),
    },
    settingsClusters: {
        ...
        useClusterURL: false,
        noAuthRequired: true,
        component: () => (_jsx(PageGrid, { children: _jsx(SettingsClusters, {}) })),
    },
    settingsCluster: {
        path: '/settings',
        exact: true,
    ...
    settingsClusterHomeContext: {
        ...
        useClusterURL: false,
        noAuthRequired: true,
        component: () => (_jsx(PageGrid, { children: _jsx(SettingsCluster, {}) })),
    },
    ...
    pluginDetails: {
        ...
        useClusterURL: false,
        noAuthRequired: true,
        component: () => _jsx(PluginSettingsDetails, {}),
    },
    portforwards: {
        path: '/portforwards',
        exact: true,
        ...
        component: () => _jsx(PortForwardingList, {}),
    },
    loadKubeConfig: {
        ...
        noAuthRequired: true,
        disabled: !helpers.isElectron(),
        component: () => _jsx(KubeConfigLoader, {}),
    },
    map: {
        path: '/map',
        exact: true,
        ...
        sidebar: 'map',
        isFullWidth: true,
        component: () => _jsx(LazyGraphView, { height: "calc(100vh - 64px)" }),
    },
};
...
export const NotFoundRoute = {
    ...
    component: () => _jsx(NotFoundComponent, {}),
    sidebar: null,
    noAuthRequired: true,
};
 ...
 */
export function getRouteUseClusterURL(route) {
...
export function createRouteURL(routeName, params = {}) {
    ...
    let cluster = params.cluster || null;
