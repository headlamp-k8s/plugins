...
declare const ClusterRoleBinding_base: {
    new (json: KubeRoleBinding, cluster?: string): {
        jsonData: KubeRoleBinding;
        _clusterName: string;
        cluster: string;
...
declare class ClusterRoleBinding extends ClusterRoleBinding_base {
    static kind: string;
