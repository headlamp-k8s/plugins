...
export class Headlamp {
     ...
     * ```
     */
    static registerPlugin(pluginId, pluginObj) {
...
window.desktopApi?.receive('currentMenu', (currentMenus) => {
