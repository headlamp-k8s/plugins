...
import { Box, Chip, FormControl, IconButton, MenuItem, Select, TextField, Typography, } from '@mui/material';
...
function isValidNamespaceFormat(namespace) {
...
function ClusterSelector(props) {
    ...
    return (_jsx(FormControl, { variant: "outlined", margin: "normal", sx: { minWidth: 250 }, children: _jsx(Select, { labelId: "settings--cluster-selector", value: currentCluster, onChange: event => {
...
export default function SettingsCluster() {
    ...
    return (_jsxs(_Fragment, { children: [_jsxs(SectionBox, { title: t('translation|Cluster Settings ({{ clusterName }})', {
                    clusterName: cluster,
                }), backLink: true, children: [_jsxs(Box, { display: "flex", justifyContent: "space-between", alignItems: "center", children: [_jsx(ClusterSelector, { clusters: clusters, currentCluster: cluster }), _jsx(Link, { routeName: "cluster", params: { cluster: cluster }, tooltip: t('translation|Go to cluster'), children: t('translation|Go to cluster') })] }), helpers.isElectron() && (_jsx(NameValueTable, { rows: [
                            {
                        ...
                        ] })), _jsx(NameValueTable, { rows: [
                            {
                                ...
                                value: (_jsx(TextField, { onChange: event => {
                                        ...
                                        : invalidNamespaceMessage, InputProps: {
