 ...
 */
export const KubeRelationEdge = memo((props) => {
    ...
    const svgPath = `M ${startPoint.x + dx},${startPoint.y + dy} C ${bendPoints[0].x + dx},${bendPoints[0].y + dy} ${bendPoints[1].x + dx},${bendPoints[1].y + dy} ${endPoint.x + dx},${endPoint.y + dy}`;
    return (_jsx(BaseEdge, { id: props.id, path: svgPath, style: {
