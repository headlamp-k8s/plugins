...
export default function Terminal(props) {
    ...
    const [container, setContainer] = useState(getDefaultContainer());
    ...
    return (_jsx(Dialog, { onClose: onClose, onFullScreenToggled: () => {
        ...
        }, keepMounted: true, withFullScreen: true, title: isAttach
            ? t('Attach: {{ itemName }}', { itemName: item.metadata.name })
            : t('Terminal: {{ itemName }}', { itemName: item.metadata.name }), ...other, children: _jsxs(DialogContent, { sx: theme => ({
                height: '100%',
                display: 'flex',
