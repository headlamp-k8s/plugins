...
var L = (e, i) => () => (i || e((i = { exports: {} }).exports, i), i.exports), q = (e, i) => {
  ...
  if (i && typeof i == "object" || typeof i == "function")
    for (let r of Ht(i))
      !Ut.call(e, r) && r !== t && M(e, r, { get: () => i[r], enumerable: !(a = Bt(i, r)) || a.enumerable });
  return e;
};
...
var se, G, X, Qt, ei, ti, Ge = U(() => {
  ...
  o(Be, "__classPrivateFieldIn");
  o(He, "__addDisposableResource");
...
`, m.message += "Or, if you meant to create an async function, pass `async: true` as an option.")), m;
      ...
      var d = t.client ? i : /* @__PURE__ */ o(function(g) {
        var h = /* @__PURE__ */ o(function(y, _) {
          ...
          return _ && (O = b.shallowCopy(O, _)), Bi(y, t)(O);
        }, "include");
        return i.apply(
          t.context,
...
var kt = require("node:path"), H = require("@storybook/core/common");
var Rt = /* @__PURE__ */ o((e) => {
  if (e)
...
luckThirdPartyPackageFromPath"), ve = /* @__PURE__ */ o(async (e) => {
  let i = {}, { builder: t } = await e.presets.apply("core"), a = await (0, H.getFrameworkName)(e);
  await (0, H.extractProperRendererNameFromFramework)(a) && (i.STORYBOOK_RENDERER = await (0, H.extractProperRendererNameFromFramework)(a) ??
  void 0);
  let n = Rt(t);
...
async function Nt(e, i) {
  return Promise.all(
    e.map(async (t, a) => {
      ...
      return await (0, ee.writeFile)(p, `import '${B(t).replaceAll(/'/g, "\\'")}';`), p;
    })
  );
}
...
var Vi = /^\/($|\?)/, ie, D, xe = /* @__PURE__ */ o(async (e) => {
  ...
  return yield, a.use("/", ({ url: E }, P, F) => {
    E && Vi.test(E) ? (P.statusCode = 200, P.write(w), P.end()) : F();
  }), a.use("/index.html", (E, P) => {
    P.statusCode = 200, P.write(w), P.end();
  }), {
    bail: $t,
    stats: {
