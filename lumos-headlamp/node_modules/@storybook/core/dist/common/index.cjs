...
var ze = {
  ...
  "@storybook/preset-html-webpack": "8.6.2",
  "@storybook/preset-preact-webpack": "8.6.2",
  "@storybook/preset-react-webpack": "8.6.2",
  "@storybook/preset-server-webpack": "8.6.2",
  "@storybook/preset-svelte-webpack": "8.6.2",
  "@storybook/preset-vue3-webpack": "8.6.2",
  "@storybook/html": "8.6.2",
  "@storybook/preact": "8.6.2",
  "@storybook/react": "8.6.2",
  "@storybook/server": "8.6.2",
...
async function eh(r) {
  try {
    ...
    return r === "@storybook/addon-essentials" ? (A.importPath = "@storybook/addon-essentials/entry-preview", A) : (A.isCoreAddon || (A.importPath =
    `${r}/preview`), require.resolve(Ah.default.join(r, "preview")), A);
  } catch {
  }
  return null;
}
...
async function th(r, A) {
  ...
  return await t.forEach(async (s) => {
    let I = await eh(s);
    if (I) {
      ...
      )) && (i.push(s), I.isCoreAddon && s !== "@storybook/addon-essentials" ? (A.setImport(I.importName, I.importPath), A.appendNodeToArray(
        ["addons"],
