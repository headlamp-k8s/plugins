 ...
 */
function DefaultEditorDialogAdapter({ open, onClose, yamlContent, title }: EditorDialogSlotProps) {
...
const TextStreamContainer = React.memo(function TextStreamContainer({
  ...
  onRetryTool,
  agentThinkingSteps,
  ContentRendererSlot = DefaultContentRenderer as unknown as React.ComponentType<ContentRendererSlotProps>,
  ...
  const renderMessage = useCallback(
          ...
          >
            {prompt.role === 'user' ? (
              ...
              <>
                ...
                {hasThinkingSteps && (
                  <AgentThinkingBlock steps={prompt.agentThinkingSteps!} isActive={!thinkingDone} />
                )}
    ...
    [history.length, theme.palette, memoizedOnYamlDetected, ContentRendererSlot, onRetryTool]
  );
