...
describe('parseSkillSourceUrl', () => {
  ...
  it('should allow GitLab URLs', () => {
    const source = parseSkillSourceUrl('https://gitlab.com/group/project');
    expect(source.url).toBe('https://gitlab.com/group/project');
  });

  it('should allow Bitbucket URLs', () => {
    const source = parseSkillSourceUrl('https://bitbucket.org/team/repo');
    expect(source.url).toBe('https://bitbucket.org/team/repo');
  });
});
