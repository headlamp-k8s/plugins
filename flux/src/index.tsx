...
registerKindDetailsPage('HelmRelease', { component: FluxHelmReleaseDetailView });
...
registerKindDetailsPage('HelmRepository', {
  component: props => <FluxSourceDetailView {...props} type="helmrepositories" />,
});
...
registerKindDetailsPage('Kustomization', {
  component: props => <FluxKustomizationDetailView {...props} />,
});
...
registerKindDetailsPage('OCIRepository', {
  component: props => <FluxSourceDetailView {...props} type="ocirepositories" />,
});
